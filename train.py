...
"""
    ...
    for margin in margins:
        for lamb in lambs:
            rate = rates[gamma]
            print("Lambda value of", lamb, "Margin value of", margin)
            ...
            print("AUC of lambda="+str(lamb)+", margin="+str(margin)+":", auc)
            ...
            X_prime_filename = "data/features_labels_X_prime_val_lambda=" + str(lamb) + "_margin=" + str(margin) + "_gamma=" + str(gamma) + ".txt"
            ...
            X_prime_filename = "data/features_labels_X_prime_test_lambda=" + str(lamb) + "_margin=" + str(margin) + "_gamma=" + str(gamma) + ".txt"
            outfile_x = open(X_prime_filename,'w')
            x_list = X_prime.tolist()
            for i in range(len(x_list)):

...
from model import Linear_Feature_Fusion_Approximate, Linear_Feature_Fusion, Linear_Feature_Fusion_No_Normal, Linear_Feature_Fusion_Approximate2
...
if __name__ == "__main__":
    ...
    train(64,100)#for gamma=128, use margin=0.25,lamb=0.1)

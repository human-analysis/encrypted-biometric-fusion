...
from model import Linear_Feature_Fusion_Approximate, Linear_Feature_Fusion, Linear_Feature_Fusion_No_Normal, Linear_Feature_Fusion_Approximate2, Linear_Feature_Fusion_Approximate3, Linear_Feature_Fusion_Batch, Linear_Feature_Fusion_Approximate2_Batch, Linear_Feature_Fusion_Batch_NoShuffle, Linear_Feature_Fusion_Approximate2_Batch_NoShuffle
...
def train_exact(gamma,iters,spec_margin=None,spec_lamb=None):
    ...
    a = []
    A_infile = open("feature-extraction/extractions/VGGFace_vgg_cplfw_2000.txt",'r')
    ...
    L_infile = open("feature-extraction/extractions/fingerprints_labels.txt",'r')
    ...
    B_infile = open("feature-extraction/extractions/fingerprints.txt",'r')
    ...
    split1 = math.floor(num_classes * 0.2) * 4
    split2 = math.floor(num_classes * 0.4) * 4
    print("labels:",len(L))
    #print(test_counter)
    ...
    shuffle_order = [i for i in range(len(X_train.tolist())//4)]
    ...
    L_list = L_train.tolist()
    print("shuffle order:",len(shuffle_order))
    for i in shuffle_order:
        #print()
        for j in range(4):
            temp_X.append(X_list[i*4+j])
            temp_L.append(L_list[i*4+j])
            #print(L_train.tolist()[i*4+j])
    X_train = torch.tensor(temp_X)
    L_train = torch.tensor(temp_L)
    
    if not os.path.exists("data5"):
        os.mkdir("data5")
    if not os.path.exists("data5/dataset"):
        os.mkdir("data5/dataset")
    if not os.path.exists("data5/exact_results"):
        os.mkdir("data5/exact_results")
    if not os.path.exists("data5/exact_results/"):
        os.mkdir("data5/dataset")

    outfile_a = open("data5/dataset/A_values.txt",'w')
    for row in A.tolist():
        for item in row:
    ...
    outfile_b = open("data5/dataset/B_values.txt",'w')
    for row in B.tolist():
        for item in row:
    ...
    outfile_a_train = open("data5/dataset/A_values_train.txt",'w')
    ...
    outfile_b_train = open("data5/dataset/B_values_train.txt",'w')
    ...
    outfile_a_test = open("data5/dataset/A_values_test.txt",'w')
    #outfile_a_test.write("[")
    #for row in A.tolist()[split2:]:
    ...
    outfile_b_test = open("data5/dataset/B_values_test.txt",'w')
    #for row in B.tolist()[split2:]:
    ...
    outfile_a_val = open("data5/dataset/A_values_val.txt",'w')
    for row in A.tolist()[:split1]:
        outfile_a_val.write("[")
        for item in row:
    ...
    outfile_b_val = open("data5/dataset/B_values_val.txt",'w')
    for row in B.tolist()[:split1]:
        outfile_b_val.write("[")
        for item in row:
    ...
    outfile_x_test = open("data5/dataset/X_values_test.txt",'w')
    ...
    outfile_L = open("data5/dataset/L_values_val.txt",'w')
    outfile_L.write(str(L_val.tolist()))
    outfile_L.close()
    
    outfile_L = open("data5/dataset/L_values_test.txt",'w')
    ...
    outfile_b_test = open("data5/dataset/A_values_test_unique.txt",'w')
    #for row in B.tolist()[split2:]:
    ...
    outfile_b_test = open("data5/dataset/B_values_test_unique.txt",'w')
    #for row in B.tolist()[split2:]:
    for row in B2.tolist()[math.floor(0.2*num_classes)*2:math.floor(0.4*num_classes)*2]:
        for item in row:
            outfile_b_test.write(str(f'{item:.9f}'))
            outfile_b_test.write(" ")
        outfile_b_test.write("\n")
    ...
    outfile_L = open("data5/dataset/L_values_test_unique.txt",'w')
    outfile_L.write(str(L2[math.floor(0.2*num_classes)*2:math.floor(0.4*num_classes)*2].tolist()))
    outfile_L.close()
    ...
    rates = {2:1000, 16:0.005, 32:0.005, 64:10000, 128: 10000, 256:10000, 512:10000}
    #rates[64] = 500
    rates[64] = 20000
    rates[64] = 0.005
    #rates[64] = 500
    ...
    for reg in regularizers:
        for margin in margins:
            for lamb in lambs:
                ...
                model = Linear_Feature_Fusion_Batch_NoShuffle(X_train,M,V,L_train,gamma,margin,lamb,regularization=reg,seed=randie)
                ...
                p_best_file_name = "data5/exact_results/exact_best_P_value_transpose_lambda=" + str(lamb) + "_margin=" + str(margin) + "_gamma=" + str(gamma)  + "_reg=" + str(reg) + ".txt"
                ...
                loss_file_name = "data5/exact_results/exact_loss_values_lambda=" + str(lamb) + "_margin=" + str(margin) + "_gamma=" + str(gamma)  + "_reg=" + str(reg) + ".txt"
                ...
                X_prime_filename = "data5/exact_results/exact_labels_X_prime_val_lambda=" + str(lamb) + "_margin=" + str(margin) + "_gamma=" + str(gamma) + "_reg=" + str(reg) + ".txt"
                ...
                X_filename = "data5/exact_results/exact_labels_X_NOT_NORMAL_test_lambda=" + str(lamb) + "_margin=" + str(margin) + "_gamma=" + str(gamma) + "_reg=" + str(reg) + ".txt"
                ...
                X_prime_filename = "data5/exact_results/exact_labels_X_prime_test_lambda=" + str(lamb) + "_margin=" + str(margin) + "_gamma=" + str(gamma) + "_reg=" + str(reg) + ".txt"
                #X_prime_filename = "data/exact_labels_X_prime_test_lambda=" + str(lamb) + "_margin=" + str(margin) + "_gamma=" + str(gamma) + "_reg=" + str(reg) + ".txt"
                outfile_x = open(X_prime_filename,'w')
                x_list = X_prime.tolist()
                for i in range(len(x_list)):
...
def train(gamma,iters,spec_margin=None,spec_lamb=None):
    ...
    if not os.path.exists("data5/degree=3strict"):
        os.mkdir("data5/degree=3strict")
    if not os.path.exists("data5/degree=2strict"):
        os.mkdir("data5/degree=2strict")
    ...
    for reg in regularizers:
        for margin in margins:
            for lamb in lambs:
                ...
                model = Linear_Feature_Fusion_Approximate2_Batch_NoShuffle(X_train,M,V,L_train,gamma,margin,lamb,regularization=reg,seed=randie)
                #model = Linear_Feature_Fusion(X_train,M,V,gamma,margin,lamb,regularization=reg)
                ...
                p_best_file_name = "data5/degree=3strict/approximate_best_P_value_transpose_lambda=" + str(lamb) + "_margin=" + str(margin) + "_gamma=" + str(gamma)  + "_reg=" + str(reg) + ".txt"
                #p_best_file_name = "data/exact_best_P_value_transpose_lambda=" + str(lamb) + "_margin=" + str(margin) + "_gamma=" + str(gamma)  + "_reg=" + str(reg) + ".txt"
                outfile_p_t = open(p_best_file_name,'w')
                P_final_t = best_P.T
                P_final_t = str(P_final_t.tolist())
                ...
                loss_file_name = "data5/degree=3strict/approximate_loss_values_lambda=" + str(lamb) + "_margin=" + str(margin) + "_gamma=" + str(gamma)  + "_reg=" + str(reg) + ".txt"
                #loss_file_name = "data/exact_loss_values_lambda=" + str(lamb) + "_margin=" + str(margin) + "_gamma=" + str(gamma)  + "_reg=" + str(reg) + ".txt"
                outfile_loss = open(loss_file_name,'w')
                for loss_value in losses:
                    outfile_loss.write(str(loss_value.tolist()))
                ...
                X_prime_filename = "data5/degree=3strict/approximate_labels_X_prime_val_lambda=" + str(lamb) + "_margin=" + str(margin) + "_gamma=" + str(gamma) + "_reg=" + str(reg) + ".txt"
                #X_prime_filename = "data/exact_labels_X_prime_val_lambda=" + str(lamb) + "_margin=" + str(margin) + "_gamma=" + str(gamma) + "_reg=" + str(reg) + ".txt"
                outfile_x = open(X_prime_filename,'w')
                x_list = X_prime.tolist()
                for i in range(len(x_list)):
                ...
                X_filename = "data5/degree=3strict/approximate_labels_X_NOT_NORMAL_test_lambda=" + str(lamb) + "_margin=" + str(margin) + "_gamma=" + str(gamma) + "_reg=" + str(reg) + ".txt"
                #X_prime_filename = "data/exact_labels_X_prime_test_lambda=" + str(lamb) + "_margin=" + str(margin) + "_gamma=" + str(gamma) + "_reg=" + str(reg) + ".txt"
                outfile_x = open(X_filename,'w')
                x_list = X_prime.tolist()
                for i in range(len(x_list)):
                ...
                X_prime_filename = "data5/degree=3strict/approximate_labels_X_prime_test_lambda=" + str(lamb) + "_margin=" + str(margin) + "_gamma=" + str(gamma) + "_reg=" + str(reg) + ".txt"
                #X_prime_filename = "data/exact_labels_X_prime_test_lambda=" + str(lamb) + "_margin=" + str(margin) + "_gamma=" + str(gamma) + "_reg=" + str(reg) + ".txt"
                outfile_x = open(X_prime_filename,'w')
                x_list = X_prime.tolist()
                for i in range(len(x_list)):

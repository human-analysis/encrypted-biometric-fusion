...
def train_exact(gamma,iters,spec_margin=None,spec_lamb=None):
    ...
    L = []
    L_infile = open("feature-extraction/extractions/deep_speaker_librispeech_large_labels.txt",'r')
    for line in L_infile:
        L.append(int(line.strip()))
    
    b = []
    B_infile = open("feature-extraction/extractions/deep_speaker_librispeech_large.txt",'r')
...
if __name__ == "__main__":
    #train_exact(64,500,0.25,0.25) #this got 0.927
    #train_exact(256,100,0.25,0.25)
    #train(64,1500,0.5,0.1)
